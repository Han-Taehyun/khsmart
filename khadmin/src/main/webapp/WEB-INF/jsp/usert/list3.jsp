...
<form id="form1" name="form1" method="post" action="schterList">
		...
		<div class="col-lg-12">
			<section class="box ">
				<header class="panel_header">
					<h2 class="title pull-left">학교선생님 목록</h2>
							...
							<table class="table">
								<thead>
									<tr>
										...
										<th style="width:*">학교</th>
										
										<th style="width:10%">연락처1</th>
										<th style="width:10%">연락처2</th>
										
										<th style="width:10%">이메일1</th>
										<th style="width:10%">이메일2</th>
								...
								<tbody>
									<c:forEach var="listview" items="${listview}" varStatus="status">
										...
										<tr>
											...
											<td>
												<a href="schterRead?sn=${listview.sn}">${listview.username}</a>
											</td>
											<td>
												<a href="schterRead?sn=${listview.sn}">${listview.userid}</a>
											</td>
											<td>
												${listview.userpw}
											</td>
											...
											<td>
												<c:if test="${listview.schoolunivfk == '0' }">지정학교없음</c:if>
												<c:if test="${listview.schoolunivfk != '0' }">
												<a href="schoolRead?sn=${listview.schoolunivfk}">${listview.elsname}</a></c:if>
											</td>
...
function fn_formSubmit() {
	document.form1.action = "schterList";
	document.form1.submit();
}
function fn_formGo() {
	document.form1.action = "schterForm";
	document.form1.submit();
	}
</script>
