...
<form name="form1" action="surveypoolNMLSaveEDM" method="post" enctype="multipart/form-data">
...
<script>
	...
	function fn_formDel() {
		document.form1.action = "surveypoolNMLDeleteEDM";
		document.form1.submit();

	}
</script>

<form name="formList" action="surveypoolNMLListEDM" method="post">
