...
@import	url('//fonts.googleapis.com/css?family=Noto+Sans+SC&display=swap');
...
#customers {border-collapse: collapse;width: 100%;font-size: 14px;font-family: 'Nanum Gothic', 'Roboto';}
#customers td, #customers th {border: 1px solid #888888;padding: 8px;font-family: 'Nanum Gothic', 'Roboto';}
.tdl {background-color: #f1f1f1;color: #333;font-weight: 700;text-align: center;font-family: 'Nanum Gothic', 'Roboto';}
a[href*="http"] {background:url('https://mdn.mozillademos.org/files/12982/external-link-52.png') no-repeat 100% 0;
	background-size: 16px 16px;
	padding-right: 19px;
}
a:link {text-decoration: none;font-weight: 700;cursor: pointer;}
a:visited {text-decoration: none;font-weight: 700;cursor: pointer;}
a:hover {text-decoration: underline;background-color: #e9e9ff;cursor: pointer;}
a:active {text-decoration: underline;font-weight: 700;background-color: #e9e9ff;cursor: pointer;}
</style>
</head>
<!-- END HEAD -->
...
<body style="font-family: 'Nanum Gothic', 'Roboto';">
	...
	<div class='page-topbar '>
		<div class='logo-area'
			style="background: url(images/logo.png) no-repeat; background-size: contain; background-position: center;"></div>
