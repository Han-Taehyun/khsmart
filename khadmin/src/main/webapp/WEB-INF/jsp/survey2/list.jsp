...
<form id="form1" name="form1" method="post" action="surveyNMLListEDM">
									...
									<tbody>
										<c:forEach var="listview" items="${listview}"
											...
											<tr>
												...
												<td><a href="surveyNMLReadEDM?sn=${listview.sn}">${listview.svname}</a></td>
...
<script>
	function fn_formSubmit() {
		document.form1.action = "surveyNMLListEDM";
...
<script>
	function fn_formGo() {
		document.form1.action = "surveyNMLFormEDM";
		document.form1.submit();
	}
</script>
