...
<form id="form1" name="form1" method="post" action="vwsList">
	...
	<section id="main-content" class=" ">
		<section class="wrapper"
			...
			<div class="col-lg-12">
				<section class="box ">
					<header class="panel_header">
						<h2 class="title pull-left">반별 설문결과 목록</h2>
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th style="width:10%">보기1 응답수</th>
											<th style="width:10%">보기2 응답수</th>
											<th style="width:10%">보기3 응답수</th>
											<th style="width:10%">보기4 응답수</th>
											<th style="width:10%">보기5 응답수</th>
									...
									<tbody>
										<c:forEach var="listview" items="${listview}"
											...
											<tr>
											<td colspan="8" style="height:250px">

			<div style="width:100%;text-align:center;border-top:2px solid #aaa;margin-top:10px;padding-top:10px">
                    <canvas id="pie-chartjs${listview.odrno}" width="300" height="300"></canvas>
			</div>
			...
			<script>
			function initChart${listview.odrno}(){
			var pieData = [
...

				{
							...
							highlight: "rgba(222,222,222,0.8)",
							label: "${listview.bogi1t} ${listview.per1} %",
							fontSize: 16
				},		

				{
							...
							value: ${listview.per2},
							color: "rgba(220,120,120,1.0)",
							highlight: "rgba(222,222,222,0.8)",
							label: "${listview.bogi2t} ${listview.per2} %",
							fontSize: 16
				},	

				{
							...
							value: ${listview.per3},
							color: "rgba(140,110,170,1.0)",
							highlight: "rgba(222,222,222,0.8)",
							label: "${listview.bogi3t} ${listview.per3} %",
							fontSize: 16
				},	
				...
				
				{
							...
							value: ${listview.per4},
							color: "rgba(160,190,120,1.0)",
							highlight: "rgba(222,222,222,0.8)",
							label: "${listview.bogi4t} ${listview.per4} %",
							fontSize: 16
				},	
						
				{
							...
							value: ${listview.per5},
							color: "rgba(140,130,220,1.0)",
							highlight: "rgba(222,222,222,0.8)",
							label: "${listview.bogi5t} ${listview.per5} %",
							fontSize: 16
				},	
					...
					var ctx = document.getElementById("pie-chartjs${listview.odrno}").getContext("2d");
					window.myPie = new Chart(ctx).Pie(pieData);
			}
			initChart${listview.odrno}();
			</script>
