...
<form name="form1" action="hpenv2Save" method="post"
			...
			<div class="col-lg-12">
				<section class="box ">
					<header class="panel_header">
						<h2 class="title pull-left">CMS 강좌 연결</h2>
						<div class="actions panel_actions pull-right">
							<i class="box_toggle fa fa-chevron-down"></i> <i
								class="box_setting fa fa-cog" data-toggle="modal"></i>
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										...
										<table id="customers">
											...
											<tr>
												...
												<td style="width: 85%" colspan="3">${packinfo.title}
													<input name="cmsbigid" type="hidden" value="${packinfo.sn}">
												</td>
											</tr>
											...
											<tr>
												...
												<td style="width: 35%"><select name="cosid"
													style="width: 250px; height: 35px; padding: 5px; padding-bottom: 10px; font-size: 13px">
														<option value="">::선택::</option>
														<c:forEach var="courseList" items="${courseList}"
															varStatus="status">
															<option value="${courseList.sn}">${courseList.title}</option>
														</c:forEach>
...
<form name="formList" action="hpenv2List" method="post">
