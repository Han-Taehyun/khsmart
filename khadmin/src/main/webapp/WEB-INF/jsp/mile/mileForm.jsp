			...
			<div class="col-lg-12">
				<section class="box ">
					<header class="panel_header">
						<h2 class="title pull-left">마일리지 적립대행</h2>
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										...
										<table id="customers">
											<tr>
												...
												<td class="tdl" style="width: 15%">포인트부과방식</td>
												<td style="width: 35%"><select name="ptype"
											...
											<tr>
												...
												<td class="tdl" style="width: 15%">포인트</td>
												<td style="width: 35%"><input id="point"
													name="point" type="text" value=""
													style="width: 120px; height: 30px"
													onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"></td>


												<td class="tdl" style="width: 15%">메모</td>
												<td style="width: 35%"><input id="memo"
													name="memo" type="text" value=""
...
<form name="formList" action="mileList" method="post">
