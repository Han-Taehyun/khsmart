...
<form id="form1" name="form1" method="post" action="PostList">
			...
			<div class="col-lg-12">
				<section class="box ">
					...
					<header class="panel_header">
						<h2 class="title pull-left">공지사항 목록</h2>
...
<script>
	function fn_formSubmit() {
		document.form1.action="PostList";
...
<script>
	function fn_readGo(_a) {
		...
		document.form1.action = "PostRead";
		document.form1.submit();
	}
</script>
