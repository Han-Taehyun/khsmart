...
<body>
	...
	<div id="login_div" class="main-div" style="padding-top: 15px">
		...
		<form name="form1" action="calSave" method="post"
			...
			<input type="hidden" name="userid"> <input name="sn"
				type="hidden" value="${mvo.sn}">
			...
			<table style="width: 100%">
				...
				<tr>
					<td width="20%" style="height: 30px; text-align: center">대상</td>
					<td width="*"><select name="customerid"
						style="width: 320px; padding: 5px">
							...
							<c:forEach var="listcomp" items="${listcomp}" varStatus="status">
								...
								<option value="${listcomp.idx}"
								<c:if test="${mvo.customerid eq listcomp.idx}">selected</c:if>
								>${listcomp.companyname}</option>
				...
				<tr>
					...
					<td width="*"><textarea name="cumemo"
							style="width: 90%; height: 170px; font-family: '맑은 고딕', verdana, san-serif;">${mvo.cumemo}</textarea>
					</td>
				</tr>
				...
				<tr>
					...
					<td width="*"><select name="mi"
						style="width: 120px; padding: 5px">
							...
							<option value="00" <c:if test="${mvo.mi eq '00'}">selected</c:if>>정각</option>
					...
					<td colspan="2"
						...
						<table style="border: 0px">
							<tr>
								...
								<td width="33%"><span class="btn btn-primary "
									onclick="up222()">저장</span></td>

								<td width="33%"><span class="btn btn-primary "
									onclick="del()">삭제</span></td>


								<td width="33%" style=""><span class="btn btn-primary "
