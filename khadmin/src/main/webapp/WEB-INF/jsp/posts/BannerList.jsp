...
<form id="form1" name="form1" method="post" action="BannerList">
			...
			<div class="col-lg-12">
				<section class="box ">
					...
					<header class="panel_header">
						<h2 class="title pull-left">배너 목록 </h2>
									...
									<tbody>
										<c:forEach var="listview" items="${listview}"
											...
											<tr>
												...
												<c:if test="${fn:indexOf(listview.imgfile, 'jpg')!= -1}">
												<img src="/images/${listview.imgfile}" width="110">
												</c:if>
												
												<c:if test="${fn:indexOf(listview.imgfile, 'png')!= -1}">
												<img src="/images/${listview.imgfile}" width="110">
												</c:if>
												...
												<c:if test="${fn:indexOf(listview.imgfile, 'pdf')!= -1}">
												<a href="/images/${listview.imgfile}">${listview.imgfile}</a>
												</c:if>
...
<script>
	function fn_formSubmit() {
		document.form1.action="BannerList";
